        ...
        <footer className="bg-black text-white py-8 ">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="flex flex-col flex-shrink-0">
                    ...
                    <p className="text-sm leading-none  mt-4">Copyright © 2025 SUPERSTAR</p>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><a href="#" className="hover:underline">Chất liệu</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><a href="#" className="hover:underline">Chính sách kiểm hàng</a></li>
                        <li><a href="#" className="hover:underline">Chính sách vận chuyển</a></li>
                        <li><a href="#" className="hover:underline">Chính sách đổi trả/bảo hành</a></li>
                    </ul>
                </div>
                {/* Cột 3: Liên hệ */}
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <p>📍 Hà Nội</p>
                            <p>28, Ngõ 8 Lê Quang Đạo</p>
                            <p>📞 0392861103</p>
                        </li>
                        <li>
                            <p>📍 Ninh Bình</p>
                            <p>Xóm Đông, Lãng Nội, Gia Viễn</p>
                            <p>📞 0355027177</p>
                        </li>
                        <li>
                            <p>✉️ <a href="mailto:hello@frcnk.com" className="hover:underline">dinhtuanduy1@gmail.com</a></p>
                        </li>
                    </ul>
                    {/* Mạng xã hội */}
                    <div className="flex space-x-4 mt-4">
                        <a href="#" className="hover:text-blue-400"><i className="fab fa-facebook" /></a>
                        <a href="#" className="hover:text-blue-400"><i className="fab fa-pinterest" /></a>
                        <a href="#" className="hover:text-blue-400"><i className="fab fa-instagram" /></a>
                        <a href="#" className="hover:text-blue-400"><i className="fab fa-youtube" /></a>
                        <a href="#" className="hover:text-blue-400"><i className="fab fa-tiktok" /></a>
                    </div>
                </div>
            </div>
        </footer>
